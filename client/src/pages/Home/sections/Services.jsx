...
function ServiceCard({ category, index }) {
  ...
  return (
    ...
    >
      <Link
        to={category.href}
        className="group relative glass rounded-2xl p-6 sm:p-7 overflow-hidden flex flex-col h-full block"
      >
        ...
        <div className="mt-6 flex items-center gap-2 text-[#e85d04]/0 group-hover:text-[#e85d04] transition-all duration-300 text-sm font-display font-semibold">
          <span>{t("services.explore")}</span>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="translate-x-0 group-hover:translate-x-1 transition-transform duration-300">
